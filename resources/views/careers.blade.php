    ...
    <div class="container my-5">
        <div class="row justify-content-center align-items-center border rounded p-2 shadow ">
            <div class="col-12 col-md-6">
                ...
                <p><b class="text-info">Cosa farai:</b><br>Gestirai le richieste di utenti che vogliono collaborare per la piattaforma o licenziarli.<br>
                ...
                <p><b class="text-info">Cosa farai:</b><br>Visionerai ogni articolo pronto per essere pubblicato</p>
                <h2>Lavora come redattore</h2>
                <p><b class="text-info">Cosa farai:</b><br>Creerai e gestirai i tuoi articoli e i tag di riferimento.</p>
            </div>
